* * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * 
* Readme file for RWTH - Mindstorms NXT Toolbox for Octave  *
* - - - - - - - - - - - - - - - - - - - - - - - - - - - - - *
*           Version 4.04-octave - November 16th, 2011       *
* * * * * * * * * * * * * * * * * * * * * * * * * * * * * * *


Please note that the following description is extracted from the toolbox version v4.04 for MATLAB! 
Adaption to the usage of Octave have to be done individually.
